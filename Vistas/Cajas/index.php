<?php include "Vistas/Templates/header.php";?>
    ...
    <button class="btn btn-primary mb-2" type="button" onclick="frmCajas();">Nueva Caja <i class="fas fa-plus"></i> </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="frmCajas">
                        ...
                        <button class="btn btn-primary" type="button" onclick="registrarCajas(event)" id="btnModificar">Registrar</button>
